    jQuery(document).ready(function(){
		...
		jQuery('.am_options').slideUp();

		

		jQuery('.am_section h3').click(function(){		

			if(jQuery(this).parent().next('.am_options').css('display')=='none')
			...
			jQuery(this).parent().next('.am_options').slideToggle('slow');	
